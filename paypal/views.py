...
@csrf_exempt
def setcheckout(request, return_url, cancel_url, error_url, template = "paypal/setcheckout.html", currency = "EUR"):
    """
    ...
    if request.POST:
        ...
        # no redirect porque es mobile, se le devuelve el token
        return HttpResponse(driver.token)
...
def docheckout(request, error_url, success_url, template = "paypal/docheckout.html", currency = "EUR"):
    """
